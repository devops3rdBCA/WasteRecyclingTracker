...
This is the frontend application for the Waste Recycling Tracker project. It is built using React and Vite and provides the user interface for families and recycling centers to manage recyclable waste entries.
...
Author
Built by Jeynisha E BCA Student | Aspiring Full Stack Developer
